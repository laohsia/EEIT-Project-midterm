...
<head>
  <meta charset="utf-8">
  <title>討論區</title>
  <link rel="stylesheet" href="Real/album.css">
  <link rel="stylesheet" href="Real/header_style.css">
  <link rel="stylesheet" href="Real/P1.css" >
  ...
  <link href="Real/album.css" rel="stylesheet">
</head>
...
<body>
  ...
  <main role="main">
    <div class=" body">
      ...
      <div class="brain1">
       <a href=T1.jsp><img src="Real/brain.jpg" width="300px" , height="300px"></a> 
      ...
      <div class="str">
        <img src="Real/str.png" width="300px" , height="300px">
        <h1 style="position: relative; color:black ;">
      ...
      <div class="cards">
        <img src="Real/cards.jpg" width="300px" , height="300px">
        <h1 style="position: relative; color:black ;">
      ...
      <div class="party">
        <img src="Real/party.jpg" width="300px" , height="300px">
        <h1 style="position: relative; color:black ;">
      ...
      <div class="co">
        <img src="Real/co.jpg" width="300px" , height="300px">
        <h1 style="position: relative; color:black ;">
      ...
      <div class="team">
        <img src="Real/team.png" width="300px" , height="300px">
        <h1 style="position: relative; color:black ;">
      ...
      <div class="speed">
        <img src="Real/cube.png" width="300px" , height="300px">
        <h1 style="position: relative; color:black ;">
      ...
      <div class="child">
        <img src="Real/child.jpg" width="300px" , height="300px">
        <h1 style="position: relative; color:black ;">
          <big><big><big>兒童類</big></big></big>
        </h1>
      </div>
      <div class="old">
        <img src="Real/old.png" width="300px" , height="300px">
        <h1 style="position: relative; color:black ;">
